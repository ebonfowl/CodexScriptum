...
def trans_global(v, x, y, z):
    ...
    # apply three rotations to a vector x y z accels for each of the global angel transformations
    ...
    # apply first passive rotation in X
    ...
    # apply next passive rotation in Y
    ...
    # apply last passive rotation in Z
