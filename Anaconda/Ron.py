...
with open('monocle_report.txt', 'w') as f:
    f.write('Monocle Data')
    f.write('\n')
    f.write('\n')
    f.write(str(adata))
...
# There is another kernal called Ito that you can use here - I don't know what that is, but if you need it I am guessing it will jest be an arg we can add to the function
